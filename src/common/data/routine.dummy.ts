...
import { IMessenger } from "@/domain/common.model";
...
export const recordDummy: IRecord[] = [
    { id: 0, status: true, date:'2026-09-29', completedAt: '2026-10-21', deletedAt:'', routineId:1 },
    { id: 1, status: false, date:'2026-09-30', completedAt: '', deletedAt:'', routineId:5 },
    ...
    { id: 4, status: false, date:'2026-09-29', completedAt: '', deletedAt:'', routineId:2 },
